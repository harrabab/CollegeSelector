...
<header class="align-center"><img src="images/carleton.jpg"" style="width: 85%; height: 369px;"></header>
				...
				<div class="row 200%">
					<div class="6u 12u$(medium)" style="width: 100%;">
						...
						<header>
							...
							<div class="container">
							<select  name="subject">
							<option value= "311" >English</option>
							<option value = "312">Chinese</option>
							 </select>
							  <br>
